...
def trainval():
  ...
  with tf.Session(config=config) as sess:
    ...
    model_file = '/home/poac/lyx/Project/ECA-LSTM/out_new/models_2/ECA-LSTM.ckpt-2001'
    ...
    path2 = os.path.join(cfg.OUTPUT.BASE_PLOT_PATH, 'prediction_DA-LSTM.txt')
    ...
    plt.savefig(path_temp, dpi=1024)
    plt.show()
    plt.close()
